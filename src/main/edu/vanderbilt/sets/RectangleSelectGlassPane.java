...
/**
 * A glass pane for creating and editing rectangle shapes
 * over the NetLogo window.
 */
public final class RectangleSelectGlassPane extends SelectGlassPane {
    ...
    public RectangleSelectGlassPane() {
        super();
    ...
    void useCreateMouseListener() {
        ...
        MouseInputAdapter mouseListener = 
            new RectangleSelectGlassPane.CreateRectMouseListener();
    ...
    void useEditMouseListener() {
        removeListeners();
        MouseInputAdapter mouseListener = 
            new RectangleSelectGlassPane.EditRectMouseListener();
        addMouseListener(mouseListener);
        addMouseMotionListener(mouseListener);  
    }
    ...
    private class EditRectMouseListener extends MouseInputAdapter {
        ...
        public void mouseMoved(final MouseEvent aEvent) {
            ...
            if (!RectangleSelectGlassPane.this.canEdit()) {
                return;
            }
        ...
        public void mouseDragged(final MouseEvent aEvent) {
            ...
            if (RectangleSelectGlassPane.this.getFixedPoint() == null) {
                return;
            }
            if (!RectangleSelectGlassPane.this.canEdit()) {
                return;
            ...
            final int leftX = 
                Math.min(
                    RectangleSelectGlassPane.this.getFixedPoint().x, 
                    p.x
                );
            ...
            final int topY = 
                Math.min(
                    RectangleSelectGlassPane.this.getFixedPoint().y, 
                    p.y
                );
            final int width = 
                Math.abs(
                    RectangleSelectGlassPane.this.getFixedPoint().x - p.x
                );
            final int height = 
                Math.abs(
                    RectangleSelectGlassPane.this.getFixedPoint().y - p.y
                );
            RectangleSelectGlassPane.this.setRect(
    ...
    private class CreateRectMouseListener extends MouseInputAdapter {
        ...
        public void mouseMoved(final MouseEvent aEvent) {
            ...
            if (compContainsPoint(currentPoint)) {
                ...
                RectangleSelectGlassPane.this.setCursor(
                    Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR)
                );
            } else {
                // if not over the NetLogo window, use the default cursor
                RectangleSelectGlassPane.this.
                    setCursor(Cursor.getDefaultCursor());
            }
        }
        ...
        public void mousePressed(final MouseEvent aEvent) {
            ...
            RectangleSelectGlassPane.this.setFixedPoint(p);
        }
