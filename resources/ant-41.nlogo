...
to setup 
 ...
 setup-step-size
 setup-omnivory
 setup-place-pheromone
 setup-show-energy-counter
 setup-hide-energy-counter
 setup-go-forward
 set showLable? true
  reset-ticks
end
