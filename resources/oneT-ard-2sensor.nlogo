...
to java-place-measure-point
  ...
  [
   ...
   set tagenttype [agent-type] of myself
...
to-report get-measures
  ...
  [
    ...
    [ 
      ...
      let datarep (list who tcolor (word "\"" tagenttype "\"") tcycles theading todometer tdistfromlast tspeed taccel) 
...
to-report get-measures-for [an-agent-type]
  let result []
  let relevant-measures measurepoints with [ tagenttype = an-agent-type ]
