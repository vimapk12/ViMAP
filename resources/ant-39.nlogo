...
to place-measure-point
  ...
  [
    ...
    set antEnergy (mean [energy] of wabbits with  [agent-kind-string = "ant"])
...
to-report get-measures
  ...
  [
    ask ? 
    [
      let datarep (list who red (word "\"" tagentkind "\"") tcycles tpopulation antEnergy theading tdistfromlast tspeed taccel tpenwidth tpencolor) 
