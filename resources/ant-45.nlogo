...
to create-predicate-list ;the list of if/otherwise blocks
...
to create-sensors-list ;creates the list of sensors to pass to java
  set sensors-list []
...
to create-blocks-list ;creates the list of blocks to pass to java
  set blocks-list []                
end

;***************************Create all the kinds of agent (wabbits generation)*****************************************
...
;Add it to the agents' list
 ask agent-kinds with [name = "unicorn" or name = "ant" or name = "pollinator" or name = "spider"
   or name = "snake" or name = "bird" or name = "flying-ant" or name = "frog"]   
...
to prepare-random-turn
 ...
 ask agent-kinds with [
   ...
   or name = "frog" or name = "snake" or name = "bird"
    ]   
