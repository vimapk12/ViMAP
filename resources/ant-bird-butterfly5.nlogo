...
to setup ;; sets up the screen
  ...
  make-other-stuff
  if butterfly? = false [make-observer]
  ...
  highlight-animation
  let commands pc:list-all "prepare"
...
;prepare-dropoff-food-here
 ...
 set showLable? true
  ...
  reset-ticks 
  if ticks = 0 [set butterfly? true]   ;; creates ticks and initializes them to 0
end
...
to create-categories-list
  set categories-list [ "Control" "Movement" "Eating" "Communicating" ]
end
...
to create-predicate-list
  set predicate-list ["nectar-here" "can-reproduce" "no-energy" "there-is-food-here" "I-am-holding-food" "at-ant-nest" "at-flying-ant-nest"  
    ...
    "I-have-200-energy" "I-have-500-energy"  "I-have-1000-energy" ]
end
...
to create-measure-option-string-lists
  ...
  set tlist lput "of agents" tlist
...
to prepare-change-energy
 ...
 ;Add it to the named agents' primitives list
  ask agent-kinds with [name = "unicorn" or name = "ant" or name = "pollinator" or name = "spider"
   ...
   or name = "queen-ant" or name = "queen-flying-ant"]   
...
to prepare-pickup-food-here
 ...
 ask agent-kinds with [name = "pollinator" or name = "unicorn" 
   or name = "ant" or name = "flying-ant" or name = "butterflies"]   
...
to prepare-random-turn
  ...
  [
    ...
    set label-after-arg " degrees in a random direction"
    set arg-list lput max-one-of args [who] arg-list
    set is-observer false
    set is-basic true
    ; other variables not applicable
 ...
 [set primitives-list lput "turn" primitives-list]    
end
to java-turn [amount-number]
...
to java-dropoff-food-here [afoodprob]
   set has-food false
   if shape = "ant-has-food" [set shape "ant"]
...
;***************************Create Vimap Block*****************************************
to prepare-ant-food-web-scenario
       create-blocks 1
  [
    set block-name "ant-food-web-scenario"
    set category "Movement"
    set arg-list []
    set is-observer false
    set is-basic true
 ...
 ;Add it to the named agents' primitives list
 ask agent-kinds with [name = "observer"]   
 [set primitives-list lput "ant-food-web-scenario" primitives-list]
    
end
;define the function      

to java-ant-food-web-scenario
     ask wabbits with [agent-kind-string != "observer"] [die]
     ask flowers [die]
     ask birds [die]
     hatch-wabbits 10
        [setxy random-xcor random-ycor
...
;****************************************************************************************
to prepare-ant-food-grab-scenario
       create-blocks 1
  [
    set block-name "ant-food-grab-scenario"
    set category "Movement"
    set arg-list []
    set is-observer false
    set is-basic true
 ...
 ;Add it to the named agents' primitives list
 ask agent-kinds with [name = "observer"]   
 [set primitives-list lput "ant-food-grab-scenario" primitives-list]
    
end
;define the function      

to java-ant-food-grab-scenario
     ask wabbits with [agent-kind-string != "observer"] [die]
     ask flowers [die]
     ask birds [die]
     hatch-wabbits 10
      ...
      hatch-wabbits 1
       ...
       hatch-wabbits 1
        ...
        show-turtle
          ...
          ask patches with [is-flying-ant-nest = true]
  [
...
to prepare-birds-and-butterflies-scenario
       create-blocks 1
  [
    set block-name "birds-and-butterflies-scenario"
    set category "Movement"
    set arg-list []
    set is-observer false
    set is-basic true
 ...
 ;Add it to the named agents' primitives list
 ask agent-kinds with [name = "observer"]   
 [set primitives-list lput "birds-and-butterflies-scenario" primitives-list]
    
end
;define the function      

to java-birds-and-butterflies-scenario
  set butterfly? true
end
;************************************************************************************
...
to place-measure-point
  ...
  [
    ...
    [
      ...
      if count wabbits with [agent-kind-string = "butterflies" ] != 0 [set t-proboscis-avg (count wabbits with [agent-kind-string = "butterflies" and is-long-beak]) / (count wabbits with [agent-kind-string = "butterflies"])]
    ]
    ...
    set t-population (count wabbits)
