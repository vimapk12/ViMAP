...
to setup 
  ...
  clear-all
  ask patches [set is-food false set is-ant-nest false set is-wasp-nest false]
 ...
 set bottle-kneck? false
 set showLable? true
 ask wabbits with [agent-kind-string = "pollinator"] [set currentcolor color]
  reset-ticks
end
...
to recolor-patch  ;; patch procedure
  ...
  if not is-ant-nest and not is-food and not is-wasp-nest   ;; adjust last condition to reduce 
  [ 
...
to create-measure-option-string-lists
  ...
  set tlist lput "of Wasps" tlist
  set measure-option-string-lists lput tlist measure-option-string-lists
  
  set tlist []
  set tlist lput "Average color" tlist
  set tlist lput "of Wasps" tlist
  set measure-option-string-lists lput tlist measure-option-string-lists
  
  set tlist []
  set tlist lput "Average size" tlist
  set tlist lput "of Wasps" tlist
  set measure-option-string-lists lput tlist measure-option-string-lists
...
to-report java-in-camouflage [aWho]
  let result false
  if turtle aWho != nobody [
  ask turtle aWho
  [
    set result shade-of? color pcolor = true
  ]]
  report result
end

to-report java-at-wasp-nest [aWho]
  let result false
  if turtle aWho != nobody [
  ask turtle aWho
  [
    set result [is-wasp-nest] of patch-here
  ]]
  report result
end
...
to-report java-at-wasp [aWho]
  let fradius 2
  let result false
  if turtle aWho != nobody [
  ask turtle aWho
  [
  set result any? wabbits in-radius fradius with [agent-kind-string = "wasp"]
  ]]
  report result
end
...
to create-blocks-list
  ...
  create-blocks 1
  [
    set block-name "not-eat-green-ants"
    set category "Movement"
    set arg-list []
    set is-observer false
    set is-basic false
    ; other variables not applicable
      ...
      create-blocks 1
  [
    set block-name "not-eat-green-wasps"
    set category "Movement"
    set arg-list []
    set is-observer false
    set is-basic true
    ; other variables not applicable
     ...
     create-blocks 1
  [
    set block-name "eat-uncamouflaged-wasps"
    set category "Movement"
    set arg-list []
    set is-observer false
    set is-basic true
   ...
   create-blocks 1
  [
    set block-name "eat-ants-smaller-than"
    set is-observer false
    set arg-list []
    hatch-args 1
    [
  ...
  create-blocks 1
  [
    set block-name "eat-wasps-larger-than"
    set is-observer false
    set arg-list []
    hatch-args 1
    [
  ...
  create-blocks 1
  [
    set block-name "eat-wasps-smaller-than"
    set is-observer false
    set arg-list []
    hatch-args 1
    [
  ...
  [
    ...
    ; other variables not applicable
      ...
      set blocks-list lput max-one-of blocks [who] blocks-list
         ...
         create-blocks 1
  [
    set block-name "reproduce-queen"
    set category "movement"
    set arg-list []
    set is-observer false
    set is-basic false
...
;    set primitives-list lput "bottle-kneck" primitives-list
;    set primitives-list lput "face-ant-nest" primitives-list
;    set primitives-list lput "face-wasp-nest" primitives-list
...
;      set primitives-list lput "not-eat-green-wasps" primitives-list
;     set primitives-list lput "eat-wasps-smaller-than" primitives-list
;     
;     set primitives-list lput "eat-wasps-larger-than" primitives-list
;  ]
...
;  set agent-kind-list lput max-one-of agent-kinds [who] agent-kind-list
 ...
 set primitives-list lput "go-forward" primitives-list
    ...
    set primitives-list lput "face-wasp-nest" primitives-list
    set primitives-list lput "face-pheromone" primitives-list
     set primitives-list lput "reproduce-wasp" primitives-list
   set primitives-list lput "Omnivory" primitives-list
    set primitives-list lput "pickup-food-here" primitives-list
    set primitives-list lput "place-pheromone" primitives-list
...
;     set primitives-list lput "show-energy-counter" primitives-list
;      set primitives-list lput "agent-die" primitives-list
;      set primitives-list lput "reproduce-queen" primitives-list
;      set primitives-list lput "place-nest" primitives-list
;  ]
;  set agent-kind-list lput max-one-of agent-kinds [who] agent-kind-list
   ...
   ; set primitives-list lput "set-paintcolor" primitives-list
    ; set primitives-list lput "tandum-running" primitives-list
     ...
     set primitives-list lput "eat-ant" primitives-list
      set primitives-list lput "eat-wasp" primitives-list
       set primitives-list lput "reproduce-spider" primitives-list
     ;  set primitives-list lput "eat-enemy" primitives-list
     set primitives-list lput "not-eat-green-ants" primitives-list
     set primitives-list lput "eat-ants-smaller-than" primitives-list
      set primitives-list lput "not-eat-green-wasps" primitives-list
     set primitives-list lput "eat-wasps-smaller-than" primitives-list
     set primitives-list lput "eat-wasps-larger-than" primitives-list
    
     set primitives-list lput "eat-uncamouflaged-wasps" primitives-list
  ]
  set agent-kind-list lput max-one-of agent-kinds [who] agent-kind-list
...
to java-pickup-food-here 
  ...
  [  if agent-kind-string  = "ant" [set shape "ant-has-food"] 
    set has-food true
...
to java-bottle-kneck 
  if ticks = 100 and  bottle-kneck? = false [
    ask n-of (count wabbits with [agent-kind-string = "wasp"] * (.9 )) wabbits with [agent-kind-string = "wasp"] [die] set bottle-kneck? true]
end
...
to java-go-forward 
 ...
 ; if shape = "flying-ant2" [set shape "flying-ant1"]
  ask wabbits with [agent-kind-string = "wasp"][
...
to place-measure-point
  ...
  [
    ...
    set tagentkind "wasp"
    set tcycles count measurepoints - 1
    set tpopulation (count wabbits with [agent-kind-string = "wasp"])
    if count wabbits with [agent-kind-string = "wasp"] > 0 [set antEnergy (mean [color] of wabbits with  [agent-kind-string = "wasp"])]
    if count wabbits with [agent-kind-string = "wasp"] > 0 [set spiderPopulation (mean [size] of wabbits with  [agent-kind-string = "wasp"])]
    set frogpopulation (count wabbits with [agent-kind-string = "frog"])
    set measurepoint-creator "wasp"
    ht
  ]
end
...
to java-create-food [acolorplaceprob]
  ;if is-food [if  random 100 < 1 [let currentcolor  [pcolor] of patch-here]]
  if random 100 < acolorplaceprob 
  [ 
    ask [ neighbors ] of patch-here  
    [
      ;set ppaint-color currentcolor  
      set pcolor [currentcolor] of myself
      set is-food true
      set is-depleted false
    ]
  ] 
 ; if random 100 < 1 [ set currentcolor pcolor]
...
to java-reproduce-ant 
  hatch 1 [
    setxy [xcor] of myself [ycor] of myself
      set NestX [xcor] of myself 
      set Nesty [ycor] of myself
...
to java-dropoff-food-here [afoodprob]
   ...
   [if agent-kind-string  = "ant" [set shape "ant"] 
     set has-food false
     set is-food true
     set is-depleted false
   ]
...
to java-Omnivory
  ...
  [let prey one-of wabbits in-radius food-radius with [agent-kind-string != [agent-kind-string] of myself and agent-kind-string != "queen-ant" and agent-kind-string != "queen-flying-ant" ]
    ...
    if prey != nobody
    [if [energy] of prey > 0 
      [set energy energy + ([energy] of prey) * .10]
      ask prey [die]    ]
  ]
...
to java-not-eat-green-ants
  let food-radius 2
  if any? wabbits in-radius food-radius with [agent-kind-string  = "ant" and shade-of? color green = false]
  [let prey one-of wabbits in-radius food-radius with [agent-kind-string = "ant"  and shade-of? color green = false]
...
to java-not-eat-green-wasps
  let food-radius 2
  if any? wabbits in-radius food-radius with [agent-kind-string  = "wasp" and shade-of? color green = false]
  [let prey one-of wabbits in-radius food-radius with [agent-kind-string = "wasp"  and shade-of? color green = false]
    
    if prey != nobody
    [if [energy] of prey > 0 
      [set energy energy + ([energy] of prey) * .1 ]
      ask prey [die]    ]
  ]
   
end

to java-eat-uncamouflaged-wasps
  let food-radius 2
  if any? wabbits in-radius food-radius with [agent-kind-string  = "wasp" and shade-of? color pcolor = false]
  [let prey one-of wabbits in-radius food-radius with [agent-kind-string = "wasp"  and shade-of? color pcolor = false]
...
to java-eat-ants-smaller-than [aSize]
  let food-radius 2
  if any? wabbits in-radius food-radius with [agent-kind-string  = "ant" and size < aSize]
  [let prey one-of wabbits in-radius food-radius with [agent-kind-string = "ant"  and size < aSize]
...
to java-eat-wasps-smaller-than [aSize]
  let food-radius 2
  if any? wabbits in-radius food-radius with [agent-kind-string  = "wasp" and size < aSize]
  [let prey one-of wabbits in-radius food-radius with [agent-kind-string = "wasp"  and size < aSize]
...
to java-eat-wasps-larger-than [aSize]
  let food-radius 2
  if any? wabbits in-radius food-radius with [agent-kind-string  = "wasp" and size > aSize]
  [let prey one-of wabbits in-radius food-radius with [agent-kind-string = "wasp"  and size > aSize]
...
to java-eat-wasp
   let food-radius 2
  if any? wabbits in-radius food-radius with [agent-kind-string  = "wasp"]
  [let prey one-of wabbits in-radius food-radius with [agent-kind-string = "wasp"  ]
...
to java-eat-grass
  if not is-depleted and not is-ant-nest and not is-wasp-nest
  [ 
    set is-food false
    set is-depleted true
...
to color-background-patches
  ...
  ask n-of random 3 patches [set pcolor black set is-ant-nest true] 
;  ask n-of .1 patches [set pcolor yellow + 3 set is-ant-nest true]
;  ask n-of .1 patches [set pcolor orange set is-ant-nest true] 
...
to java-place-nest
  if shape = "flying-ant2" [
    fd 1 set heading heading - random 10
    if random 1000 < 10
    [ask patches with [distancexy 0 0 < 4]
  [
    set is-ant-nest true
...
true
1
Polygon -2674135 true true 136 61 129 46 144 30 119 45 124 60 114 82 97 37 132 10 93 36 111 84 127 105 172 105 189 84 208 35 171 11 202 35 204 37 186 82 177 60 180 44 159 32 170 44 165 60
Polygon -2674135 true true 150 95 135 103 139 117 125 149 137 180 135 196 150 204 166 195 161 180 174 150 158 116 164 102
Polygon -2674135 true true 149 186 128 197 114 232 134 270 149 282 166 270 185 232 171 195 149 186
